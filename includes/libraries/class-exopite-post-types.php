...
class Exopite_Post_Types {
    ...
    private function register_single_post_type( $fields ) {
        ...
        $labels = array(
            ...
            'new_item'              => sprintf( __( 'New %s', 'wp-sdtrk' ), $fields['singular'] ),
            'add_new_item'          => sprintf( __( 'Add new %s', 'wp-sdtrk' ), $fields['singular'] ),
            'edit_item'             => sprintf( __( 'Edit %s', 'wp-sdtrk' ), $fields['singular'] ),
            'view_item'             => sprintf( __( 'View %s', 'wp-sdtrk' ), $fields['singular'] ),
            'view_items'            => sprintf( __( 'View %s', 'wp-sdtrk' ), $fields['plural'] ),
            'search_items'          => sprintf( __( 'Search %s', 'wp-sdtrk' ), $fields['plural'] ),
            'not_found'             => sprintf( __( 'No %s found', 'wp-sdtrk' ), strtolower( $fields['plural'] ) ),
            'not_found_in_trash'    => sprintf( __( 'No %s found in trash', 'wp-sdtrk' ), strtolower( $fields['plural'] ) ),
            'all_items'             => sprintf( __( 'All %s', 'wp-sdtrk' ), $fields['plural'] ),
            'archives'              => sprintf( __( '%s Archives', 'wp-sdtrk' ), $fields['singular'] ),
            'attributes'            => sprintf( __( '%s Attributes', 'wp-sdtrk' ), $fields['singular'] ),
            'insert_into_item'      => sprintf( __( 'Insert into %s', 'wp-sdtrk' ), strtolower( $fields['singular'] ) ),
            'uploaded_to_this_item' => sprintf( __( 'Uploaded to this %s', 'wp-sdtrk' ), strtolower( $fields['singular'] ) ),

            /* Labels for hierarchical post types only. */
            'parent_item'           => sprintf( __( 'Parent %s', 'wp-sdtrk' ), $fields['singular'] ),
            'parent_item_colon'     => sprintf( __( 'Parent %s:', 'wp-sdtrk' ), $fields['singular'] ),
        ...
        if ( isset( $fields['rewrite'] ) ) {
            ...
            /**
             *  Add $this->wp_sdtrk as translatable in the permalink structure,
    ...
    private function register_single_post_type_taxnonomy( $tax_fields ) {
        ...
        $labels = array(
            ...
            'all_items'                  => sprintf( __( 'All %s' , 'wp-sdtrk' ), $tax_fields['plural'] ),
            'edit_item'                  => sprintf( __( 'Edit %s' , 'wp-sdtrk' ), $tax_fields['single'] ),
            'view_item'                  => sprintf( __( 'View %s' , 'wp-sdtrk' ), $tax_fields['single'] ),
            'update_item'                => sprintf( __( 'Update %s' , 'wp-sdtrk' ), $tax_fields['single'] ),
            'add_new_item'               => sprintf( __( 'Add New %s' , 'wp-sdtrk' ), $tax_fields['single'] ),
            'new_item_name'              => sprintf( __( 'New %s Name' , 'wp-sdtrk' ), $tax_fields['single'] ),
            'parent_item'                => sprintf( __( 'Parent %s' , 'wp-sdtrk' ), $tax_fields['single'] ),
            'parent_item_colon'          => sprintf( __( 'Parent %s:' , 'wp-sdtrk' ), $tax_fields['single'] ),
            'search_items'               => sprintf( __( 'Search %s' , 'wp-sdtrk' ), $tax_fields['plural'] ),
            'popular_items'              => sprintf( __( 'Popular %s' , 'wp-sdtrk' ), $tax_fields['plural'] ),
            'separate_items_with_commas' => sprintf( __( 'Separate %s with commas' , 'wp-sdtrk' ), $tax_fields['plural'] ),
            'add_or_remove_items'        => sprintf( __( 'Add or remove %s' , 'wp-sdtrk' ), $tax_fields['plural'] ),
            'choose_from_most_used'      => sprintf( __( 'Choose from the most used %s' , 'wp-sdtrk' ), $tax_fields['plural'] ),
            'not_found'                  => sprintf( __( 'No %s found' , 'wp-sdtrk' ), $tax_fields['plural'] ),
        );
