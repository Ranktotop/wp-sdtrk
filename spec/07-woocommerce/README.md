...
| [product-feed.md](product-feed.md) | RSS-2.0/`g:`-Produkt-Feed, Token-Endpoint, täglicher Cron, Ausschluss-Liste, Google-Kategorie-Mapping, Bild-Qualitätsprüfung |
| [feed-management.md](feed-management.md) | Admin-Seite zur Steuerung, welche Produkte im Feed sind, mit Qualitäts-Spalte & Google-Kategorie-Panel (versteckte Seite, AJAX) |
...
| Produkt-Feed (Ausschluss-Liste, Google-Kategorie-Mapping, Bild-Check) | [public/class-wp-sdtrk-wc-feed.php](../../public/class-wp-sdtrk-wc-feed.php) |
...
| Feed-Verwaltung (AJAX `list_feed_products`/`save_feed_exclusion`/`list_gpc_categories`/`save_gpc_map`) | [admin/class-wp-sdtrk-admin-ajax.php](../../admin/class-wp-sdtrk-admin-ajax.php) |
| Gebündelte Google-Produkttaxonomie (Autocomplete) | [admin/data/google-product-taxonomy-de.txt](../../admin/data/google-product-taxonomy-de.txt) |
