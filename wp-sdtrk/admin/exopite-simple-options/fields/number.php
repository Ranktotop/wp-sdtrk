 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_number' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_number extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
