 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_image_select' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_image_select extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
