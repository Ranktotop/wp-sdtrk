 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_text' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_text extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
