 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_content' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_content extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
