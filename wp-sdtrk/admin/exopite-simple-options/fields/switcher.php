 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_switcher' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_switcher extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
