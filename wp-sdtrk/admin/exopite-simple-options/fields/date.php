 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_date' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_date extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
