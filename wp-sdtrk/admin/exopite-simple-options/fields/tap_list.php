 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_tap_list' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_tap_list extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
