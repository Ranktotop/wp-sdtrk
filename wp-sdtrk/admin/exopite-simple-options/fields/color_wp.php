 ...
 *
 */
if ( ! class_exists( 'Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_color_wp' ) ) {

	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_color_wp extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
