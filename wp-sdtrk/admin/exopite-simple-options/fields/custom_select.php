	...
	class Wp_Sdtrk_Exopite_Simple_Options_Framework_Field_custom_select extends Wp_Sdtrk_Exopite_Simple_Options_Framework_Fields {
		...
		public function output() {
			...
			if ( isset( $this->field['options'] ) || isset( $this->field['query'] ) ) {
				...
				$this->license = ( isset( $this->field['attributes']['license'] ) ) ? $this->field['attributes']['license'] : $this->license;
				...
				if ( ! empty( $select ) ) {
					...
					foreach ( $select as $key => $value ) {
					    echo '<option '.$disabled.' value="' . $key . '" ' . $this->checked( $this->element_value(), $key, 'selected' ) . '>' . $value . '</option>';
